...
import cidMapping from './../../assets/country-id-mapping.json';
...
export class WorldMapComponent implements OnInit {
  ...
  ngOnInit(): void {
    Object.keys(cidMapping).forEach((countryName) => {
      this.countryIdMapping[countryName] = cidMapping[countryName];
    });
